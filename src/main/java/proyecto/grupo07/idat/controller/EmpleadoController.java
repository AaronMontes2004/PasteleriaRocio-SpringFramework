...
import proyecto.grupo07.idat.service.EmpleadoService;
import proyecto.grupo07.idat.util.pagination.PageRender;
import proyecto.grupo07.idat.util.reportes.EmpleadoExporterExcel;
import proyecto.grupo07.idat.util.reportes.EmpleadoExporterPDF;
...
public class EmpleadoController {
	...
	public String verDetallesDelEmpleado(@PathVariable(value = "id") Long id,Map<String,Object> modelo,RedirectAttributes flash) {
		...
		return "/SeccionAdministrativa/ver";
	}
	...
	public String listarEmpleados(@RequestParam(name = "page",defaultValue = "0") int page,Model modelo) {
		...
		return "/SeccionAdministrativa/listar";
	}
	...
	public String mostrarFormularioDeRegistrarCliente(Map<String,Object> modelo) {
		...
		return "/SeccionAdministrativa/form";
	}
